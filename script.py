...
parser.add_argument("--scale", dest="scale", type=float, help="scale of time axis for walltime duration ")
...
save_plot(get_value_by_key(data, "WallDurationSeconds"), "./graph", "wall_duration_plot", "WallDurationSeconds", args.scale)
